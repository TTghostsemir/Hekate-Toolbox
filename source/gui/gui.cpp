...
inline void Gui::drawPixel(s16 x, s16 y, color_t clr) {
    ...
    framebuffer[off] = blendColor(framebuffer[off], clr.r, clr.a);
    off++;
    framebuffer[off] = blendColor(framebuffer[off], clr.g, clr.a);
    off++;
    framebuffer[off] = blendColor(framebuffer[off], clr.b, clr.a);
    off++;
