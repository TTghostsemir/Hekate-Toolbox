...
GuiMain::GuiMain() : Gui() {
    ...
    overrideKeysMenuButton->drawAction = [&](Gui *gui, u16 x, u16 y, bool *isActivated) {
        ...
        gui->drawTextAligned(font14, x + 100, y + 185, currTheme.textColor, "Aendere der override Taste", ALIGNED_CENTER);
    };
    ...
    autobootSelectorButton->inputAction = [&](u32 kdown, bool *isActivated) {
        if (kdown & HidNpadButton_A) {
            ...
            (new ListSelector("Hekate autoboot profile", "\uE0E1 Zurueck     \uE0E0 OK", autobootNames, currAutoBootEntryIndex))
    ...
    backgroundServicesButton->drawAction = [&](Gui *gui, u16 x, u16 y, bool *isActivated) {
        ...
        gui->drawTextAligned(font20, x + 37, y + 50, currTheme.textColor, "System Module", ALIGNED_LEFT);
    };
    ...
    rebootButton->drawAction = [&](Gui *gui, u16 x, u16 y, bool *isActivated) {
        ...
        gui->drawTextAligned(font20, x + 55, y + 50, currTheme.textColor, "Neustart in Hekate", ALIGNED_LEFT);
    };
...
void GuiMain::draw() {
    ...
    Gui::drawTextAligned(font24, Gui::g_framebuffer_width / 2, Gui::g_framebuffer_height - 130, currTheme.textColor, "Druecke \uE044 zum Speichern und zum home menu zurueck zu gehen", ALIGNED_CENTER);
