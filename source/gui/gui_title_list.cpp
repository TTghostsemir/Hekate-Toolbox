...
void GuiTitleList::draw() {
    ...
    Gui::drawTextAligned(font24, Gui::g_framebuffer_width / 2 - m_targetOffsetX, 150 - m_targetOffsetY, currTheme.textColor, "Waehlen Sie den Titel, den Sie Overriden moechten.", ALIGNED_CENTER);
